...
All scripts assume that processed feature CSV files and team roster files are placed under
the `data/` directory following the formats generated by scripts in `Processing/`.
