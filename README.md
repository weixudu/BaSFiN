...
### Figure 3 — Convergence Trend of Player Uncertainty (σ)

- Dataset: 2013–2024

Figure 3 illustrates the convergence trajectories of posterior uncertainty parameters (σ)
...
### Figure 4 — Validation AUC Comparison Across Training Strategies and Model Architectures

- Dataset: 2009–2024

Figure 4 compares validation AUC across different BaSFiN model variants as a function
...
### Figure 5 — Validation AUC Surface over KL Weight and Learning Rate

- Dataset: 2013–2024

Figure 5 reports the validation AUC surface of the BaSFiN model as a function of the
...
---
### Table 3 - Feature screening via RMSE
...
### Table 5 — Test-set Performance Comparison Between BaS and BT
...
### Table 6 — Statistical Significance Tests (BaS vs. BT)

Table 6 reports statistical significance tests used to assess whether the performance
...
### Table 7 — Impact of Dynamic (EMA-Based) Features

Table 7 evaluates the effect of incorporating dynamic, EMA-based temporal features
...
### Tables 8 — Player statistics

Table 8 summarizes the players with the lowest and highest posterior uncertainties. For most players, σ decreases steadily during training. This analysis demonstrates how the model accounts for the stability of player skill estimates as more data is incorporated.

- Evaluation setting: 2013-2024
- Script location:
