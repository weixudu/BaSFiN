...
The reported scores are derived from the learned competition and cooperation modules
...
These case studies demonstrate that the learned interaction representations capture
meaningful and human-interpretable basketball relationships, supporting the validity
of the proposed modeling framework beyond aggregate performance metrics.

- Results are generated using interaction inspection and logging scripts:
