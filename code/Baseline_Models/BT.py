...
def main():
    ...
    for trial_idx in range(num_trials):
        ...
        if val_auc > best_auc:
            ...
            # 如果有 validation split 就輸出 valid，否則輸出 test
             ...
             step1_out_path = os.path.join(output_dir, f'test_avg_preds_labels_step1_{current_time}.csv')
    ...
    file_path_avg = os.path.join(output_dir, f'test_avg_preds_labels_step2_{current_time}.csv')
